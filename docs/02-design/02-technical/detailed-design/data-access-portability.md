...
read-only ทั้งหมด — คืน `Receipt` **ทุกสถานะ** ของทุกทุนที่ผู้เรียกถือ (ไม่ใช่แค่สถานะ "ผ่าน" แบบ
[[export-verified-report]]/OP-10), `VerificationResult` ทั้งหมดที่เกี่ยวข้อง, และ `ConsentRecord`
ทั้งหมด (ประวัติให้/ถอนความยินยอม) — ตั้งใจแยกเจตนาจาก OP-10 อย่างชัดเจน (สำเนาข้อมูลส่วนบุคคลตาม
สิทธิ์ PDPA ไม่ใช่รายงานสรุปสำหรับยื่นเจ้าหน้าที่การเงิน)
...
sequenceDiagram
    ...
    B->>DS: รวบรวม Receipt ทุกสถานะของทุกทุนที่ผู้เรียกถือ
...
|---|---|---|---|
| [[api-spec#OP-16 ขอสำเนาข้อมูลส่วนบุคคลของตนเอง\|OP-16]] | [[db-spec#E-03 ใบเสร็จ (Receipt)\|Receipt]] (E-03) | อ่าน (**ทุกสถานะ**, ทุกทุนของผู้เรียก) | ครบถ้วนกว่า [[export-verified-report]] เสมอ (ไม่กรองเฉพาะ "ผ่าน") |
| OP-16 | [[db-spec#E-06 ผลตรวจใบเสร็จ (VerificationResult)\|VerificationResult]] (E-06) | อ่าน (ทั้งหมดที่เกี่ยวข้อง) | รวมทุก record แม้ใบเสร็จถูกส่งตรวจซ้ำหลายรอบ (append-only history) |
| OP-16 | [[db-spec#E-09 ประวัติความยินยอม (ConsentRecord)\|ConsentRecord]] (E-09) | อ่าน (ทั้งหมด) | รวมประวัติให้/ถอนความยินยอมทุกครั้ง ไม่ใช่แค่ record ล่าสุด |
