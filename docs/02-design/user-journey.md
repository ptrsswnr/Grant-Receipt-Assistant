...
flowchart TD
    ...
    H["อัปโหลดไฟล์ใบเสร็จของค่าใช้จ่าย 1 เรื่อง ผูกกับทุนของตนเอง อาจมีหลายไฟล์สูงสุด 5 ไฟล์ต่อรายการ พร้อมคำเตือนให้อัปโหลดครั้งละ 1 รายการ (FR-01, FR-22)"]
...
4. อัปโหลดไฟล์ใบเสร็จของค่าใช้จ่าย 1 เรื่อง (jpg/png หรือ PDF สแกน) ผูกกับทุนวิจัยของตนเอง — 1 รายการ
   ใบเสร็จ (ชุดเอกสารหลักฐานของค่าใช้จ่าย 1 เรื่อง) อาจประกอบด้วยมากกว่า 1 ไฟล์/แผ่น (เช่น ค่ารถตู้
   ตามระเบียบมหาวิทยาลัยต้องมี "ใบสำคัญรับเงิน" + "สำเนาบัตรผู้รับเงิน" รวมกัน) สูงสุด **5 ไฟล์ต่อ
   รายการ** ต้องอัปโหลดไฟล์ทั้งหมดของค่าใช้จ่ายเรื่องเดียวกันพร้อมกันในครั้งเดียวและผูกกับ record
   เดียวกัน ไม่ใช่แยกเป็นใบเสร็จคนละรายการ (ใบเสร็จ 1 แผ่นที่มีสินค้าหลายชิ้นจากร้านเดียวกันยังนับเป็น
   รายการเดียว ไม่ต้องแยก) ระหว่างขั้นตอนนี้ระบบต้องแสดงข้อความเตือน/คำแนะนำให้อัปโหลดครั้งละ 1
   รายการเท่านั้น เพื่อป้องกันความสับสนอัปโหลดใบเสร็จหลายรายการปนกันในครั้งเดียว
...
5. ระบบตรวจสอบความถูกต้องของไฟล์ที่อัปโหลดก่อนส่งเข้า OCR เสมอ (ชนิดไฟล์ที่รองรับ, ไฟล์ไม่เสียหาย/
   ...
   **ไฟล์ไม่ถูกต้องหรือมีจำนวนไฟล์เกินที่กำหนด** → ระบบปฏิเสธการอัปโหลด (หรือไฟล์ส่วนเกิน) ทันทีพร้อม
   ...
   แล้ววนกลับไปขั้นตอนที่ 4 ให้อัปโหลดใหม่ ถ้า**ไฟล์ถูกต้องครบตามเงื่อนไข** → ไปขั้นตอนถัดไป
